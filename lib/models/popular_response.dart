class PopularRespone {
  String? status;
  String? copyright;
  int? numResults;
  List<Popular>? populars;

  PopularRespone({this.status, this.copyright, this.numResults, this.populars});

  PopularRespone.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        populars!.add(Popular.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (populars != null) {
      data['results'] = populars!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
